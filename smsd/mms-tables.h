...
typedef enum _MMSResponseStatus {
	MMS_RESP_OK = 128,
	MMS_RESP_ERR_UNSPECIFIED = 129,
	MMS_RESP_ERR_SERVICE_DENIED = 130,
	MMS_RESP_ERR_MSG_FMT_CORRUPT = 131,
	MMS_RESP_ERR_SND_ADDR_UNRESOLVED = 132,
	MMS_RESP_ERR_MSG_NOT_FOUND = 133,
	MMS_RESP_ERR_NETWORK = 134,
	MMS_RESP_ERR_CONTENT_NOT_ACCEPTED = 135,
	MMS_RESP_ERR_MSG_UNSUPPORTED = 136,
} MMSResponseStatus;

extern MMSVALUEENUM MMS_YESNO_YES;
extern MMSVALUEENUM MMS_YESNO_NO;
