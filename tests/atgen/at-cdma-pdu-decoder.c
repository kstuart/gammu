...
void decode_pdu_gsm(void)
{
  ...
  const char *pdu_hex = "0881104168900250431906120747401002000900156161616161616161616162626262626262626262";
  const size_t pdu_len = strlen(pdu_hex);
...
void decode_pdu_gsm_multi(void)
{
  ...
  const char *pdu_hex = "0881104168900250431906120747401005000901180500035F02024646464646464646464646464646414141";
  const size_t pdu_len = strlen(pdu_hex);
...
void decode_pdu_octet_multi(void)
{
  ...
  const char *pdu_hex = "";
  const size_t pdu_len = strlen(pdu_hex);
