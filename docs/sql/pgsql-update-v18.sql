...
drop table if exists sentitems_mms_parts;
create table sentitems_mms_parts (
    "ID" serial not null constraint sentitems_mms_parts_pkey primary key,
    "SENTITEMS_ID" integer not null,
    "MediaType" varchar(1024) not null,
    "DataLength" integer not null,
    "Data" bytea not null,
    "End" integer not null default 0
...
drop index if exists sentitems_mms_parts_sentitems_id;
create index sentitems_mms_parts_sentitems_id on sentitems_mms_parts ("SENTITEMS_ID");
